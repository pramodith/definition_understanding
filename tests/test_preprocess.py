...
def test_clean_definition():
    ...
    assert clean_definition("This is a definition (with clarification)") == "This is a definition"
    
    # Test normalizing whitespace
    assert clean_definition("This   is  a   definition") == "This is a definition"
    
    # Test combined cases
    assert clean_definition("This   is  a [2] definition (with clarification)") == "This is a definition"
...
def test_create_evaluation_dataset():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        # Create dummy data
        data = {
            'word': ['apple', 'banana', 'cat', 'supercalifragilisticexpialidocious', 'a'],
            'definition': [
