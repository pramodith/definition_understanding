...
def test_is_correct_answer():
    ...
    assert is_correct_answer("vegetable", "apple", synonyms=["fruit", "produce"]) is False
...
def test_calculate_metrics():
    ...
    # Create test results
    results = [
        {"word": "apple", "definition": "A fruit", "prediction": "apple", "synonyms": ["fruit"]},
        {"word": "banana", "definition": "A yellow fruit", "prediction": "banana", "synonyms": ["fruit"]},
        {"word": "cat", "definition": "A feline animal", "prediction": "dog", "synonyms": ["feline"]},
        {"word": "dog", "definition": "A canine animal", "prediction": "canine", "synonyms": ["canine"]},
    ]
...
def test_analyze_results_by_category():
    ...
    results = [
        {"word": "apple", "definition": "A fruit", "prediction": "apple", "part_of_speech": "noun", "synonyms": []},
        {"word": "banana", "definition": "A yellow fruit", "prediction": "banana", "part_of_speech": "noun", "synonyms": []},
        {"word": "run", "definition": "To move quickly", "prediction": "sprint", "part_of_speech": "verb", "synonyms": ["sprint"]},
        {"word": "happy", "definition": "Feeling joy", "prediction": "sad", "part_of_speech": "adjective", "synonyms": []},
    ]
